...
const List<ChangelogEntry> changelog = [
  ...
  ChangelogEntry(
    ...
    date: '2026-08-31',
    features: [
      'Kutlama sesi tezahurat oldu: gunun tum gorevleri bitince konfetiyle birlikte alkis ve tezahurat caliyor',
    ],
  ),
  ChangelogEntry(
    version: '0.39.0',
    date: '2026-08-31',
    features: [
      'Kutlamaya ses eklendi: gunun tum gorevleri bitince konfetiyle birlikte yumusak bir can sesi caliyor',
    ],
  ),
  ChangelogEntry(
    version: '0.38.0',
